...
function exibirImagens() {
    ...
    gallery.classList.add("image-gallery-visible"); // Adiciona a classe que aumenta o tamanho das imagens
...
function minimizarImagens() {
    ...
    // Esconde a galeria
    gallery.classList.remove("image-gallery-visible"); // Remove a classe que aumenta o tamanho das imagens
